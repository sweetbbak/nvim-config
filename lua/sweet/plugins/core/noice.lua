        ...
        config = function()
            require("noice").setup({
                routes = {
                    ...
                    { filter = { find = "Warning" }, view = "mini" },
                    { filter = { find = "deprecated" }, view = "mini" },
                    { filter = { find = "position_encoding" }, view = "mini" },
                    ...
                    { filter = { find = "more lines" }, view = "mini" },
                    { filter = { find = "fewer lines" }, view = "mini" },

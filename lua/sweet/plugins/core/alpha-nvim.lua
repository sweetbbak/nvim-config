...
return {
    ...
    config = function()
        ...
        -- make a list of keys and then pick a random index
        local keys = {}
        for k in pairs(ART) do
            table.insert(keys, k)
        end

        -- display a random header art
        local choiceIndex = math.random(1, #keys)
        local choiceKey = keys[choiceIndex]
        local choice = ART[choiceKey]

        dashboard.section.header.val = choice
